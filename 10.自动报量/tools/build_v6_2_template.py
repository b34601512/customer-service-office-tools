...
OUTPUT_WORKBOOK_PATH = HTML_TOOL_DIR / "2026年智能报量-v6.2.xlsx"
OUTPUT_CONFIG_PATH = HTML_TOOL_DIR / "report-config.js"
AUDIT_CSV_PATH = HTML_TOOL_DIR / "v6.2料号核对表.csv"
QA_JSON_PATH = HTML_TOOL_DIR / "v6_2_build_qa.json"
...
def log(action: str, module: str, sub_action: str) -> None:
    print(f"[build_v6_2_template.py][主线:{action}][{module}][{sub_action}]")
...
def write_report_config(config: dict) -> None:
    text = (
        "// 该文件由 v6.2 构建脚本生成，目的是真实记录手工6月结构和料号映射，避免人工抄错。\n"
