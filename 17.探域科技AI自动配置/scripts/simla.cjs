...
(async () => {
  ...
  try {
    ...
    await box.fill('你好，请问为啥感觉氧气是辣的？');
    console.log('FILLED');
    await page.screenshot({ path: 'C:/Users/b3460/.pi-edge-work/sim-la-before.png' });
    ...
    await page.screenshot({ path: 'C:/Users/b3460/.pi-edge-work/sim-la-after.png' });
