...
(async () => {
  ...
  const t = await page.evaluate(() => document.body.innerText.slice(-2500));
  console.log('EDITOR', JSON.stringify(t).slice(0, 1800));
  await page.screenshot({ path: 'C:/Users/b3460/.pi-edge-work/strategy-editor.png' });
  console.log('DONE');
  await ctx.close();
})();
